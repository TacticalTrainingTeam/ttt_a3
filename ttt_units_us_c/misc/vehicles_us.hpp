...
class TTT_Truppfuehrer_Base_Us : TTT_Base_Us {
    ...
    items[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_HelmetCam", "ACE_CableTie", "ACE_CableTie", "ACE_CableTie", "ACE_microDAGR", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
...
class TTT_Mgschuetze_Base_Us : TTT_Base_Us {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "rhsusf_acc_eotech_552", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
    respawnitems[] = { "rhsusf_acc_eotech_552", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
...
class TTT_Lmgschuetze_Base_Us : TTT_Base_Us {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "rhsusf_acc_eotech_552", "rhsusf_acc_ELCAN", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
    respawnitems[] = { "rhsusf_acc_eotech_552", "rhsusf_acc_ELCAN", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
    linkedItems[] = { "BWA3_G_Combat_Clear", "TTT_Vest_Heavy_Base", "TTT_Helmet_4_Us_Desert", "ItemMap", "ItemCompass", "ItemWatch", "tf_anprc152" };
    respawnLinkedItems[] = { "BWA3_G_Combat_Clear", "TTT_Vest_Heavy_Base", "TTT_Helmet_4_Us_Desert", "ItemMap", "ItemCompass", "ItemWatch", "tf_anprc152" };
...
class TTT_Feldarzt_Base_Us : TTT_Base_Us {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_microDAGR", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
