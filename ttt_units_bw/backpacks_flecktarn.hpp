/*
	...
	*/
	...
	class TTT_Backpack_Mgassistent_Bw_Flecktarn : TTT_Backpack_Mgassistent_Bw_Tropentarn {
		displayName = "TTT MG-Assistent Rucksack (BW Flecktarn)";
		hiddenSelectionsTextures[] = {"\A3\weapons_f\ammoboxes\bags\data\backpack_compact_rgr_co.paa"};
	};
	
	//MG-Schuetze Rucksack
	class TTT_Backpack_Mgschuetze_Bw_Flecktarn : TTT_Backpack_Mgschuetze_Bw_Tropentarn {
		displayName = "TTT MG-Schuetze Rucksack (BW Flecktarn)";
		hiddenSelectionsTextures[] = {"\A3\weapons_f\ammoboxes\bags\data\backpack_compact_rgr_co.paa"};
	};
	
	//AT-Schuetze Rucksack
	class TTT_Backpack_Atschuetze_Bw_Flecktarn : TTT_Backpack_Atschuetze_Bw_Tropentarn {
		displayName = "TTT AT-Schuetze Rucksack (BW Flecktarn)";
		hiddenSelectionsTextures[] = {"\A3\weapons_f\ammoboxes\bags\data\backpack_compact_rgr_co.paa"};
	};	
	
	//Schuetze Rucksack
	class TTT_Backpack_Schuetze_Bw_Flecktarn : TTT_Backpack_Schuetze_Bw_Tropentarn {
	...
	//Feldarzt Rucksack
	class TTT_Backpack_Feldarzt_Bw_Flecktarn : TTT_Backpack_Feldarzt_Bw_Tropentarn {
