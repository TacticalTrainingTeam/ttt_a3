/*
	...
	Author: Joris-Jan van 't Land, edited by MAD T to make use for Zeus creation saving
...
private ["_anchorPos", "_anchorDim", "_grabOrientation", "_objs"];
_anchorPos = _this param [0, [0, 0], [[]]];
_anchorDim = _this param [1, 50, [-1]];
_grabOrientation = _this param [2, false, [false]];
_player = _this select 3;
_logic = getAssignedCuratorLogic _player;
_objs = curatorEditableObjects _logic;
...
[_outputText,"NSS_AC_fnc_curatorSaveDone",_player,false] spawn BIS_fnc_MP;