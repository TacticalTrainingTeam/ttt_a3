class CfgVehicles {
    ...
    class rnt_bw_wintertarn_uniform: CUP_Creatures_Military_CHDKZ_Soldier_04 {
        ...
        hiddenSelectionsTextures[] = {
            QPATHTOF(rsr_retex_cup\data\uniform\rnt_winter_jacke_co.paa),
            QPATHTOF(rsr_retex_cup\data\uniform\rnt_winter_hose_co.paa)
        };
    };
    ...
    class rsr_c_161: CUP_B_C130J_USMC {
        ...
        editorPreview = QPATHTOF(rsr_retex_cup\data\planes\previews\rsr_c_161_preview.jpg);
        editorSubcategory = "EdSubcat_Planes";
        faction = "rsr";
        hiddenSelectionsTextures[] =  {
            QPATHTOF(rsr_retex_cup\data\planes\redd_c_161_body_co.paa),
            QPATHTOF(rsr_retex_cup\data\planes\redd_c_161_wings_co.paa)
        };
    };
