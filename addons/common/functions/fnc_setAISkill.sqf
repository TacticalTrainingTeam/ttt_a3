 ...
 * 7: Spot Distance Skill (Optional, Default: 0.85) <FLOAT>
 * 8: Spot Time Skill (Optional, Default: 0.85) <FLOAT>
 * 9: Reload Speed Skill (Optional, Default: 0.75) <FLOAT>
 *
 * Return Value:
 * None
 *
 ...
 * [unit, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25,] call ttt_common_fnc_setAIskill
 *
 * Public: Yes
 */
