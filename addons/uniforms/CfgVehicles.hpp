class CfgVehicles {
    ...
    class ttt_Platinum_Pilot : ttt_Base_US {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Platinum_Pilot_preview.jpg);
        scope = 1;
    ...
    class ttt_Yellow_US_Desert : ttt_Base_US {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Yellow_US_Desert_preview.jpg);
        scope = 1;
    ...
    class ttt_Grey_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Grey_US_Desert_preview.jpg);
    ...
    class ttt_Gold_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Gold_US_Desert_preview.jpg);
    ...
    class ttt_Green_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Green_US_Desert_preview.jpg);
    ...
    class ttt_Brown_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Brown_US_Desert_preview.jpg);
    ...
    class ttt_Black_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Black_US_Desert_preview.jpg);
    ...
    class ttt_Red_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Red_US_Desert_preview.jpg);
    ...
    class ttt_Bronze_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Bronze_US_Desert_preview.jpg);
    ...
    class ttt_Blue_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Blue_US_Desert_preview.jpg);
    ...
    class ttt_Violet_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Violet_US_Desert_preview.jpg);
    ...
    class ttt_White_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_White_US_Desert_preview.jpg);
...
/*     class ttt_Silver_US_Desert : ttt_Yellow_US_Desert {
    ...
    class ttt_Orange_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Orange_US_Desert_preview.jpg);
    ...
    class ttt_Platinum_US_Desert : ttt_Yellow_US_Desert {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Platinum_US_Desert_preview.jpg);
    ...
    class ttt_Yellow_BW_Flecktarn : ttt_Base_BW {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Yellow_BW_Flecktarn_preview.jpg);
        scope = 1;
    ...
    class ttt_Grey_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Grey_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Gold_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Gold_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Green_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Green_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Brown_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Brown_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Black_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Black_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Red_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Red_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Bronze_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Bronze_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Blue_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Blue_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Violet_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Violet_BW_Flecktarn_preview.jpg);
    ...
    class ttt_White_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_White_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Silver_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Silver_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Orange_BW_Flecktarn : ttt_Yellow_BW_Flecktarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Orange_BW_Flecktarn_preview.jpg);
    ...
    class ttt_Yellow_BW_Tropentarn : ttt_Base_BW {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Yellow_BW_Tropentarn_preview.jpg);
        scope = 1;
    ...
    class ttt_Grey_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Grey_BW_Tropentarn_preview.jpg);
    ...
    class ttt_Gold_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Gold_BW_Tropentarn_preview.jpg);
    ...
    class ttt_Green_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Green_BW_Tropentarn_preview.jpg);
    ...
    class ttt_Brown_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Brown_BW_Tropentarn_preview.jpg);
    ...
    class ttt_Black_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Black_BW_Tropentarn_preview.jpg);
    ...
    class ttt_Red_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Red_BW_Tropentarn_preview.jpg);
    ...
    class ttt_Bronze_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Bronze_BW_Tropentarn_preview.jpg);
    ...
    class ttt_Blue_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Blue_BW_Tropentarn_preview.jpg);
    ...
    class ttt_Violet_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Violet_BW_Tropentarn_preview.jpg);
    ...
    class ttt_White_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_White_BW_Tropentarn_preview.jpg);
...
/*     class ttt_Silver_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
    ...
    class ttt_Orange_BW_Tropentarn : ttt_Yellow_BW_Tropentarn {
        ...
        editorPreview = QPATHTOF(data\previews\ttt_Orange_BW_Tropentarn_preview.jpg);
