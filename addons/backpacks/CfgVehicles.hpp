class CfgVehicles {
    ...
    class ttt_backpack_radio_coyote: ttt_Radiobackpack_Base {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_coyote_co.paa);
    ...
    class ttt_backpack_radio_olive: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_olive_co.paa);
     ...
     class ttt_backpack_radio_brown_us_desert: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_brown_us_desert_co.paa);
    ...
    class ttt_backpack_radio_bronze_us_desert: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_bronze_us_desert_co.paa);
    ...
    class ttt_backpack_radio_green_us_desert: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_green_us_desert_co.paa);
    ...
    class ttt_backpack_radio_grey_us_desert: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_grey_us_desert_co.paa);
    ...
    class ttt_backpack_radio_gold_us_desert: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_gold_us_desert_co.paa);
    ...
    class ttt_backpack_radio_platinum_us_desert: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_platinum_us_desert_co.paa);
    ...
    class ttt_backpack_radio_silver_us_desert: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_silver_us_desert_co.paa);
    ...
    class ttt_backpack_radio_white_us_desert: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_white_us_desert_co.paa);
    ...
    class ttt_backpack_radio_yellow_us_desert: ttt_backpack_radio_coyote {
        ...
        picture = QPATHTOF(data\pictures\ttt_backpack_radio_yellow_us_desert_co.paa);
