...
/*
 * Author: Seth Duda
 * Gets all active rope indexes and position labels
 *
 * Arguments:
 * 0: Vehicle <OBJECT>
 *
 * Return Value:
 * Array of active rope indexes with labels <ARRAY>
 *
 * Example:
 * [_vehicle] call ttt_advancedslingloading_fnc_getActiveRopes
 *
 * Public: No
 */
