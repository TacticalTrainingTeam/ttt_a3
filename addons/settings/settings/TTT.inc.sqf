...
force ttt_drone_tarp_buildTime = 6;
force ttt_drone_tarp_useAnimation = true;
force ttt_drone_tarp_buildAnimation = "Acts_carFixingWheel";
force ttt_medic_tarp_additionalItems = "[]";
force ttt_medic_tarp_buildAnimation = "Acts_carFixingWheel";
force ttt_medic_tarp_buildTime = 20;
force ttt_medic_tarp_useAnimation = true;
...
force ttt_signal_tarp_buildTime = 6;
force ttt_signal_tarp_useAnimation = true;
force ttt_signal_tarp_buildAnimation = "Acts_carFixingWheel";
