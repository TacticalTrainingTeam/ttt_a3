// Merged medical settings (ACE Medical + KAT + KAM)


// --- BEGIN ACE_Medical.sqf ---
// ACE Medical
...
// --- BEGIN ACE_MedicalInterface.sqf ---
...
// --- END ACE_MedicalInterface.sqf ---


// --- BEGIN ACE_MedicalTreatment.sqf ---
...
force force ace_medical_treatment_timeCoefficientPAK = 4;
force force ace_medical_treatment_treatmentTimeAutoinjector = 2.5;
force force ace_medical_treatment_treatmentTimeBodyBag = 7.5;
...
force force ace_medical_treatment_treatmentTimeSplint = 3.5;
...
force force ace_medical_treatment_treatmentTimeTrainedTourniquet = 1.5;
force force ace_medical_treatment_woundReopenChance = 1;
force force ace_medical_treatment_woundStitchTime = 5;
// --- END ACE_MedicalTreatment.sqf ---


// --- BEGIN KAT_ADVMedicalAirway.sqf ---
...
// --- END KAT_ADVMedicalAirway.sqf ---


// --- BEGIN KAT_ADVMedicalBreathing.sqf ---
...
// --- BEGIN KAT_ADVMedicalCirculation.sqf ---
...
force force kat_circulation_treatmentTime_BPCuff = 6;
force force kat_circulation_treatmentTime_StethHR = 4;
force force kat_circulation_useLocation_AED = 0;
// --- END KAT_ADVMedicalCirculation.sqf ---


// --- BEGIN KAM_Feedback.sqf ---
//KAM Feedback
force force kat_feedback_effectLowSpO2 = 85;
// --- END KAM_Feedback.sqf ---


// --- BEGIN KAM_Hypothermia.sqf ---
//KAM Hypothermia
force force kat_hypothermia_hypothermiaActive = false;
// --- END KAM_Hypothermia.sqf ---
...
force force kat_misc_treatmentTimeDetachTourniquet = 3.5;
// --- END KAM_MISC.sqf ---


// --- BEGIN KAM_Ophtalmology.sqf ---
//KAM Ophtalmology
...
// --- END KAM_Ophtalmology.sqf ---


// --- BEGIN KAM_Pharmacy.sqf ---
//KAM Pharmacy
...
force force kat_pharma_CheckCoag_TreatmentTime = 5;
...
force force kat_pharma_treatmentTime_Caffeine = 3.5;
force force kat_pharma_treatmentTime_Carbonate = 3.5;
force force kat_pharma_treatmentTime_CWMP = 3.5;
force force kat_pharma_treatmentTime_EACA = 3.5;
force force kat_pharma_treatmentTime_EpinephrineIV = 3.5;
force force kat_pharma_treatmentTime_Etomidate = 3.5;
force force kat_pharma_treatmentTime_Fentanyl = 3.5;
force force kat_pharma_treatmentTime_Flumazenil = 3.5;
force force kat_pharma_treatmentTime_Ketamine = 3.5;
force force kat_pharma_treatmentTime_Lidocaine = 3.5;
force force kat_pharma_treatmentTime_Lorazepam = 3.5;
