...
eine dynamische Kiste (Munition, Granaten, Panzerabwehr, Sprengstoff, Support)
direkt an der angeklickten Position anfordern können, ohne zuvor eines der
Zeus-Module aus dem Support-Menü zu platzieren. Die fest vorgegebenen Kisten
sind bewusst nicht enthalten - die kann Zeus direkt aus der Objektliste setzen. Nutzt intern
