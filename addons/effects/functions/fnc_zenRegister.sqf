...
[CSTRING(category_effects), CSTRING(condensedBreathModule_displayName), {
    [[], FUNC(condensedBreathInit)] remoteExec ["call", ([0, -2] select isDedicated), true];
...
[CSTRING(category_environment), CSTRING(stormModule_displayName), {
    [
        ...
        ],
        {
            ...
            [[_duration, _effect, _stormType, _walk, _direction], FUNC(stormInit)] remoteExec ["call", 0, true];
        }
