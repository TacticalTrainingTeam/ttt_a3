...
private _ladderIcon = QPATHTOEF(402_ladder,data\ui\holdaction_ladder.paa);

// Leiter Links aufbauen
[
    _veh,
    LELSTRING(402_ladder,attachLadder),
    _ladderIcon,
    _ladderIcon,
    ...
    {},
    {
        ...
        private _ladder = [_vehicle, [-1.0, -1.7, -0.3], 270] call EFUNC(402_ladder,attachLadder);
        _vehicle setVariable [QGVAR(ladderLeft), _ladder, true];

        [_ladder, _caller] call EFUNC(402_ladder,adjustLadder);
    },
    {},
    [],
    HOLD_TIME,
...
[
    ...
    {
        params ["_vehicle", "_caller"];
        private _ladder = [_vehicle, [1.0, -1.7, -0.3], 90] call EFUNC(402_ladder,attachLadder);
...
_veh addAction [
    LELSTRING(402_ladder,adjustLadder),
    {
