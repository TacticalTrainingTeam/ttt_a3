/*
#############################################################
### Flecktarn Rucksaecke
#############################################################
*/

//Truppfuehrer Rucksack
class TTT_Backpack_Teamleader_BW_Flecktarn : TTT_Backpack_Teamleader_BW_Tropentarn {
...
class TTT_Backpack_Assistant_MG_BW_Flecktarn : TTT_Backpack_Assistant_MG_BW_Tropentarn {
    displayName = "TTT MG-Assistent Rucksack (BW Flecktarn)";
    hiddenSelectionsTextures[] = {"\A3\weapons_f\ammoboxes\bags\data\backpack_compact_rgr_co.paa"};
};

//MG-Schuetze Rucksack
class TTT_Backpack_Soldier_MG_BW_Flecktarn : TTT_Backpack_Soldier_MG_BW_Tropentarn {
    displayName = "TTT MG-Schuetze Rucksack (BW Flecktarn)";
    hiddenSelectionsTextures[] = {"\A3\weapons_f\ammoboxes\bags\data\backpack_compact_rgr_co.paa"};
};

//AT-Schuetze Rucksack
class TTT_Backpack_Soldier_AT_BW_Flecktarn : TTT_Backpack_Soldier_AT_BW_Tropentarn {
    displayName = "TTT AT-Schuetze Rucksack (BW Flecktarn)";
    hiddenSelectionsTextures[] = {"\A3\weapons_f\ammoboxes\bags\data\backpack_compact_rgr_co.paa"};
};

//Schuetze Rucksack
class TTT_Backpack_Soldier_BW_Flecktarn : TTT_Backpack_Soldier_BW_Tropentarn {
    displayName = "TTT Schuetze Rucksack (BW Flecktarn)";
    hiddenSelectionsTextures[] = {"\A3\weapons_f\ammoboxes\bags\data\backpack_compact_rgr_co.paa"};
};
...
//Pionier Rucksack
class TTT_Backpack_Pioneer_BW_Flecktarn : TTT_Backpack_Pioneer_BW_Tropentarn {
...
//OPL Rucksack
class TTT_Backpack_Commander_BW_Flecktarn : TTT_Backpack_Commander_BW_Tropentarn {
