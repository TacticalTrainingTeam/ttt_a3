...
//Grau 6 (Schuetze)
class TTT_Grau6_Desert : TTT_Base_us {
    author = "Tactical Training Team";
    scope = 2;
...
class TTT_Adler1_Desert : TTT_Pilot_Base_us {
    ...
    uniformClass = "TTT_Uniform_Silber_Desert";
...
/*
#############################################################
### Trupp Habicht (Desert)
#############################################################
*/

//Habicht 1 (Pilot)
class TTT_Habicht1_Desert : TTT_Pilot_Base_us {
    author = "Tactical Training Team";
    scope = 2;
...
//Habicht 2 (Copilot)
class TTT_Habicht2_Desert : TTT_Pilot_Base_us {
    author = "Tactical Training Team";
    scope = 2;
