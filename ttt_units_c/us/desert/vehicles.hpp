	...
	*/
	...
	class TTT_Gelb1_Desert : TTT_Truppfuehrer_Base_us {
		...
		linkedItems[] = {"BWA3_G_Combat_Clear","BWA3_Vest_Leader_Tropen","TTT_Helmet_1_Desert","ItemMap","ItemCompass","ItemGPS","ItemWatch","tf_anprc152"};
		respawnLinkedItems[] = {"BWA3_G_Combat_Clear","BWA3_Vest_Leader_Tropen","TTT_Helmet_1_Desert","ItemMap","ItemCompass","ItemGPS","ItemWatch","tf_anprc152"};
	};
	...
	class TTT_Gelb2_Desert : TTT_Funkerfac_Base_us {
		...
		uniformClass = "TTT_Uniform_Gelb_Desert";
		hiddenSelectionsTextures[] = {"\ttt_units\us\desert\TTT_uniform_yellow_desert.paa"};
		linkedItems[] = {"BWA3_G_Combat_Clear","BWA3_Vest_Leader_Tropen","TTT_Helmet_2_Desert","ItemMap","ItemCompass","ItemGPS","ItemWatch","tf_anprc152"};
		respawnLinkedItems[] = {"BWA3_G_Combat_Clear","BWA3_Vest_Leader_Tropen","TTT_Helmet_2_Desert","ItemMap","ItemCompass","ItemGPS","ItemWatch","tf_anprc152"};
	};
	...
	*/
	...
	class TTT_Weiss1_Desert : TTT_Feldarzt_Base_us {
		...
		linkedItems[] = {"BWA3_G_Combat_Clear","BWA3_Vest_Medic_Tropen","TTT_Helmet_1_Desert","ItemMap","ItemCompass","ItemGPS","ItemWatch","tf_anprc152"};
		respawnLinkedItems[] = {"BWA3_G_Combat_Clear","BWA3_Vest_Medic_Tropen","TTT_Helmet_1_Desert","ItemMap","ItemCompass","ItemGPS","ItemWatch","tf_anprc152"};
	};
	...
	class TTT_Weiss3_Desert : TTT_Feldarzt_Base_us {
		...
		uniformClass = "TTT_Uniform_Weiss_Desert";
		hiddenSelectionsTextures[] = {"\ttt_units\us\desert\TTT_uniform_white_desert.paa"};
		linkedItems[] = {"BWA3_G_Combat_Clear","BWA3_Vest_Medic_Tropen","TTT_Helmet_3_Desert","ItemMap","ItemCompass","ItemGPS","ItemWatch","tf_anprc152"};
		respawnLinkedItems[] = {"BWA3_G_Combat_Clear","BWA3_Vest_Medic_Tropen","TTT_Helmet_3_Desert","ItemMap","ItemCompass","ItemGPS","ItemWatch","tf_anprc152"};
	};
