/*
	...
	*/
	...
	class TTT_Truppfuehrer_Base_us : TTT_Base_us {
		...
		items[] = {"ACE_NVG_Wide","rhsusf_acc_eotech_552","ACE_HelmetCam","ACE_CableTie","ACE_CableTie","ACE_CableTie"};
		respawnitems[] = {"ACE_NVG_Wide","rhsusf_acc_eotech_552","ACE_HelmetCam","ACE_CableTie","ACE_CableTie","ACE_CableTie"};
	...
	class TTT_Grenadier_Base_us : TTT_Base_us {
		...
		uniformClass = "TTT_Uniform_Base";
		items[] = {"ACE_NVG_Wide","rhsusf_acc_eotech_552"};
		respawnitems[] = {"ACE_NVG_Wide","rhsusf_acc_eotech_552"};
	...
	class TTT_Mgschuetze_Base_us : TTT_Base_us {
		...
		uniformClass = "TTT_Uniform_Base";
		items[] = {"rhsusf_acc_eotech_552","ACE_NVG_Wide"};
		respawnitems[] = {"rhsusf_acc_eotech_552","ACE_NVG_Wide"};
		...
		magazines[] = {"SmokeShell","SmokeShell","SmokeShellGreen","SmokeShellGreen","SmokeShellPurple","ACE_HandFlare_Green","ACE_HandFlare_Green","ACE_IR_Strobe_Item","ACE_IR_Strobe_Item","ACE_M84","ACE_M84","rhsusf_mag_7x45acp_MHP","rhsusf_mag_7x45acp_MHP","rhsusf_100Rnd_762x51_m80a1epr"};
		respawnMagazines[] = {"SmokeShell","SmokeShell","SmokeShellGreen","SmokeShellGreen","SmokeShellPurple","ACE_HandFlare_Green","ACE_HandFlare_Green","ACE_IR_Strobe_Item","ACE_IR_Strobe_Item","ACE_M84","ACE_M84","rhsusf_mag_7x45acp_MHP","rhsusf_mag_7x45acp_MHP","rhsusf_100Rnd_762x51_m80a1epr"};
		hiddenSelectionsTextures[] = {"\ttt_a3\ttt_units\us\desert\uniforms\TTT_uniform_black_Desert.paa"};
	};
	...
	class TTT_Lmgschuetze_Base_us : TTT_Base_us {
		...
		uniformClass = "TTT_Uniform_Base";
		items[] = {"rhsusf_acc_eotech_552","rhsusf_acc_ELCAN","ACE_NVG_Wide"};
		respawnitems[] = {"rhsusf_acc_eotech_552","rhsusf_acc_ELCAN","ACE_NVG_Wide"};
		linkedItems[] = {"BWA3_G_Combat_Clear","TTT_Vest_Heavy_Base","TTT_Helmet_4_Desert","ItemMap","ItemCompass","ItemWatch","tf_anprc152"};
		respawnLinkedItems[] = {"BWA3_G_Combat_Clear","TTT_Vest_Heavy_Base","TTT_Helmet_4_Desert","ItemMap","ItemCompass","ItemWatch","tf_anprc152"};
		...
		magazines[] = {"SmokeShell","SmokeShell","SmokeShellGreen","SmokeShellGreen","SmokeShellPurple","ACE_HandFlare_Green","ACE_HandFlare_Green","ACE_IR_Strobe_Item","ACE_IR_Strobe_Item","ACE_M84","ACE_M84","rhsusf_mag_7x45acp_MHP","rhsusf_mag_7x45acp_MHP","rhsusf_200Rnd_556x45_soft_pouch"};
		respawnMagazines[] = {"SmokeShell","SmokeShell","SmokeShellGreen","SmokeShellGreen","SmokeShellPurple","ACE_HandFlare_Green","ACE_HandFlare_Green","ACE_IR_Strobe_Item","ACE_IR_Strobe_Item","ACE_M84","ACE_M84","rhsusf_mag_7x45acp_MHP","rhsusf_mag_7x45acp_MHP","rhsusf_200Rnd_556x45_soft_pouch"};
		hiddenSelectionsTextures[] = {"\ttt_a3\ttt_units\us\desert\uniforms\TTT_uniform_black_Desert.paa"};
	};
	...
	class TTT_Uavoperator_Base_us : TTT_Base_us {
		...
		uniformClass = "TTT_Uniform_Base";
		items[] = {"ACE_NVG_Wide","rhsusf_acc_eotech_552","ACE_UAVBattery","ACE_DK10_b"};
		respawnitems[] = {"ACE_NVG_Wide","rhsusf_acc_eotech_552","ACE_UAVBattery","ACE_DK10_b"};
