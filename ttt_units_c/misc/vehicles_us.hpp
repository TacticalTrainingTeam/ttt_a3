...
class TTT_Truppfuehrer_Base_us : TTT_Base_us {
    ...
    items[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_HelmetCam", "ACE_CableTie", "ACE_CableTie", "ACE_CableTie", "ACE_microDAGR", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
    respawnitems[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_HelmetCam", "ACE_CableTie", "ACE_CableTie", "ACE_CableTie", "ACE_microDAGR", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
...
class TTT_Grenadier_Base_us : TTT_Base_us {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
    respawnitems[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
...
class TTT_Mgschuetze_Base_us : TTT_Base_us {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "rhsusf_acc_eotech_552", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
    respawnitems[] = { "rhsusf_acc_eotech_552", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
...
class TTT_Lmgschuetze_Base_us : TTT_Base_us {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "rhsusf_acc_eotech_552", "rhsusf_acc_ELCAN", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
    respawnitems[] = { "rhsusf_acc_eotech_552", "rhsusf_acc_ELCAN", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
    linkedItems[] = { "BWA3_G_Combat_Clear", "TTT_Vest_Heavy_Base", "TTT_Helmet_4_Desert", "ItemMap", "ItemCompass", "ItemWatch", "tf_anprc152" };
    respawnLinkedItems[] = { "BWA3_G_Combat_Clear", "TTT_Vest_Heavy_Base", "TTT_Helmet_4_Desert", "ItemMap", "ItemCompass", "ItemWatch", "tf_anprc152" };
...
class TTT_Feldarzt_Base_us : TTT_Base_us {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_microDAGR", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
    respawnitems[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_microDAGR", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
    linkedItems[] = { "BWA3_G_Combat_Clear", "TTT_Vest_Heavy_Base", "TTT_Helmet_1_Desert", "ItemMap", "ItemCompass", "ItemWatch", "tf_anprc152" };
    respawnLinkedItems[] = { "BWA3_G_Combat_Clear", "TTT_Vest_Heavy_Base", "TTT_Helmet_1_Desert", "ItemMap", "ItemCompass", "ItemWatch", "tf_anprc152" };
...
class TTT_Uavoperator_Base_us : TTT_Base_us {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_UAVBattery", "ACE_DK10_b", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
    respawnitems[] = { "ACE_NVG_Wide", "rhsusf_acc_eotech_552", "ACE_UAVBattery", "ACE_DK10_b", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item" };
