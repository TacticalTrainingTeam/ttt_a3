...
class TTT_Truppfuehrer_Base : TTT_Base_Base {
    ...
    items[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_HelmetCam", "ACE_CableTie", "ACE_CableTie", "ACE_CableTie", "ACE_microDAGR", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools" };
    respawnitems[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_HelmetCam", "ACE_CableTie", "ACE_CableTie", "ACE_CableTie", "ACE_microDAGR", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools" };
...
class TTT_Grenadier_Base : TTT_Base_Base {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools" };
    respawnitems[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools" };
...
class TTT_Atschuetze_Base : TTT_Base_Base {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "BWA3_optic_NSA80", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools" };
    respawnitems[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "BWA3_optic_NSA80", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools" };
...
class TTT_Feldarzt_Base : TTT_Base_Base {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_microDAGR" };
    respawnitems[] = { "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_microDAGR" };
...
class TTT_Uavoperator_Base : TTT_Base_Base {
    ...
    uniformClass = "TTT_Uniform_Base";
    items[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_UAVBattery", "ACE_DK10_b", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools" };
    respawnitems[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_UAVBattery", "ACE_DK10_b", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools" };
