/*
	...
	*/
	...
	class TTT_Truppfuehrer_Base : TTT_Base_Base {
		...
		items[] = {"BWA3_optic_NSV600","ACE_NVG_Wide","ACE_HelmetCam","ACE_CableTie","ACE_CableTie","ACE_CableTie"};
		respawnitems[] = {"BWA3_optic_NSV600","ACE_NVG_Wide","ACE_HelmetCam","ACE_CableTie","ACE_CableTie","ACE_CableTie"};
	...
	class TTT_Grenadier_Base : TTT_Base_Base {
		...
		uniformClass = "TTT_Uniform_Base";
		items[] = {"BWA3_optic_NSV600","ACE_NVG_Wide"};
		respawnitems[] = {"BWA3_optic_NSV600","ACE_NVG_Wide"};
	...
	class TTT_Mgschuetze_Base : TTT_Base_Base {
		...
		magazines[] = {"SmokeShell","SmokeShell","SmokeShellGreen","SmokeShellGreen","SmokeShellPurple","ACE_HandFlare_Green","ACE_HandFlare_Green","ACE_IR_Strobe_Item","ACE_IR_Strobe_Item","ACE_M84","ACE_M84","11Rnd_45ACP_Mag","11Rnd_45ACP_Mag","BWA3_120Rnd_762x51","BWA3_120Rnd_762x51"};
		respawnMagazines[] = {"SmokeShell","SmokeShell","SmokeShellGreen","SmokeShellGreen","SmokeShellPurple","ACE_HandFlare_Green","ACE_HandFlare_Green","ACE_IR_Strobe_Item","ACE_IR_Strobe_Item","ACE_M84","ACE_M84","11Rnd_45ACP_Mag","11Rnd_45ACP_Mag","BWA3_120Rnd_762x51","BWA3_120Rnd_762x51"};
		hiddenSelectionsTextures[] = {"\ttt_a3\ttt_units\bw\tropentarn\uniforms\TTT_uniform_black_tropentarn.paa"};
	};
	...
	class TTT_Lmgschuetze_Base : TTT_Base_Base {
		...
		magazines[] = {"SmokeShell","SmokeShell","SmokeShellGreen","SmokeShellGreen","SmokeShellPurple","ACE_HandFlare_Green","ACE_HandFlare_Green","ACE_IR_Strobe_Item","ACE_IR_Strobe_Item","ACE_M84","ACE_M84","11Rnd_45ACP_Mag","11Rnd_45ACP_Mag","BWA3_200Rnd_556x45","BWA3_200Rnd_556x45"};
		respawnMagazines[] = {"SmokeShell","SmokeShell","SmokeShellGreen","SmokeShellGreen","SmokeShellPurple","ACE_HandFlare_Green","ACE_HandFlare_Green","ACE_IR_Strobe_Item","ACE_IR_Strobe_Item","ACE_M84","ACE_M84","11Rnd_45ACP_Mag","11Rnd_45ACP_Mag","BWA3_200Rnd_556x45","BWA3_200Rnd_556x45"};
		hiddenSelectionsTextures[] = {"\ttt_a3\ttt_units\bw\tropentarn\uniforms\TTT_uniform_black_tropentarn.paa"};
	};
	...
	class TTT_Atschuetze_Base : TTT_Base_Base {
		...
		uniformClass = "TTT_Uniform_Base";
		items[] = {"BWA3_optic_NSV600","ACE_NVG_Wide","BWA3_optic_NSA80"};
		respawnitems[] = {"BWA3_optic_NSV600","ACE_NVG_Wide","BWA3_optic_NSA80"};
	...
	class TTT_Uavoperator_Base : TTT_Base_Base {
		...
		uniformClass = "TTT_Uniform_Base";
		items[] = {"BWA3_optic_NSV600","ACE_NVG_Wide","ACE_UAVBattery","ACE_DK10_b"};
		respawnitems[] = {"BWA3_optic_NSV600","ACE_NVG_Wide","ACE_UAVBattery","ACE_DK10_b"};
