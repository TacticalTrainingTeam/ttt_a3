	...
	*/
	...
	class TTT_Crate_Weapons_US : Box_NATO_Wps_F {
	...
	class TTT_Crate_Weapons_Special_US : Box_NATO_WpsSpecial_F {
		author = "$STR_Tactical_Training_Team";
	...
	class TTT_Crate_Ammo_Standard_US : Box_NATO_Ammo_F {
		author = "$STR_Tactical_Training_Team";
	...
	class TTT_Crate_Ammo_Special_US : Box_NATO_Ammo_F {
		author = "$STR_Tactical_Training_Team";
	...
	class TTT_Crate_Equipment_Pioneer_US : Box_NATO_AmmoOrd_F {
		author = "$STR_Tactical_Training_Team";
	...
	class TTT_Crate_Ammo_Grenade_US : Box_NATO_Grenades_F {
		author = "$STR_Tactical_Training_Team";
	...
	class TTT_Crate_Equipment_US : Box_NATO_Support_F {
		author = "$STR_Tactical_Training_Team";
	...
	class TTT_Crate_Large_US : B_SupplyCrate_F {
		author = "$STR_Tactical_Training_Team";
