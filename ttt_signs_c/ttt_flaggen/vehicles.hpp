	...
	class TTT_Flagge_Logo : TTT_Flagge_Base {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_logo_co.paa'";
		};
	};
	class TTT_Flagge_Blau : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_blau_co.paa'";
		};
	};
	class TTT_Flagge_Braun : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_braun_co.paa'";
		};
	};
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_bronze_co.paa'";
		};
	};
	class TTT_Flagge_Gelb : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_gelb_co.paa'";
		};
	};
	class TTT_Flagge_Gold : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_gold_co.paa'";
		};
	};
	class TTT_Flagge_Grau : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_grau_co.paa'";
		};
	};
	class TTT_Flagge_Gruen : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_gruen_co.paa'";
		};
	};
	class TTT_Flagge_Rot : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_rot_co.paa'";
		};
	};
	class TTT_Flagge_Schwarz : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_schwarz_co.paa'";
		};
	};
	class TTT_Flagge_Silber : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_silber_co.paa'";
		};
	};
	class TTT_Flagge_Violett : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_violett_co.paa'";
		};
	};
	class TTT_Flagge_Weiss : TTT_Flagge_Logo {
		...
		class EventHandlers {
			init = "(_this select 0) setFlagTexture '\ttt_signs\ttt_logos\ttt_weiss_co.paa'";
		};
	};