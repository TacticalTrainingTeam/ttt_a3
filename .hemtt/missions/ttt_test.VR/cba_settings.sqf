...
force ttt_stein_medic_backpack_facitlityObject = "Land_MedicalTent_01_floor_dark_F";
force ttt_stein_medic_backpack_additionalItems = '["Land_Camping_Light_F","Land_FirstAidKit_01_open_F","Land_Defibrillator_F"]';
force ttt_stein_medic_backpack_buildTime = 4;
force ttt_stein_medic_backpack_useAnimation = true;
