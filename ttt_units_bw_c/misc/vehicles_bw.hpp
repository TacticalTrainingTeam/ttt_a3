...
class TTT_Truppfuehrer_Base_Bw : TTT_Base_Bw {
    ...
    items[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_HelmetCam", "ACE_CableTie", "ACE_CableTie", "ACE_CableTie", "ACE_microDAGR", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
...
class TTT_Grenadier_Base_Bw : TTT_Base_Bw {
    ...
    uniformClass = "TTT_Uniform_Base_Bw";
    items[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
...
class TTT_Atschuetze_Base_Bw : TTT_Base_Bw {
    ...
    uniformClass = "TTT_Uniform_Base_Bw";
    items[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "BWA3_optic_NSA80", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
    respawnitems[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "BWA3_optic_NSA80", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50" };
...
class TTT_Funkerfac_Base_Bw : TTT_Base_Bw {
    ...
    uniformClass = "TTT_Uniform_Base_Bw";
    items[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50", "ACE_microDAGR" };
    respawnitems[] = { "BWA3_optic_NSV600", "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50", "ACE_microDAGR" };
...
class TTT_Feldarzt_Base_Bw : TTT_Base_Bw {
    ...
    uniformClass = "TTT_Uniform_Base_Bw";
    items[] = { "ACE_NVG_Wide", "ACE_IR_Strobe_Item", "ACE_IR_Strobe_Item", "ACE_MapTools", "ACE_Flashlight_XL50", "ACE_microDAGR" };
